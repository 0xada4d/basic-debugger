...
# Start at the address of your shellcode on the stack
# See if the shellcode you input is the same as the shellcode in memory
# If not, program outputs bad char
