...
# Get handle to process we will inject to
...
# Allocate space for shellcode, returning the start address of allocated chunk
...
# Create our thread, beginning at the start address of the shellcode
thread_id = c_ulong(0)
