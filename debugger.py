...
# 9) ReadProcessMemory and WriteProcessMemory allow us to set bp's within process
    ...
    def get_debug_event(self):
        ...
        if kernel32.WaitForDebugEvent(byref(debug_event), 100):
            ...
            if debug_event.dwDebugEventCode == EXCEPTION_DEBUG_EVENT:
                self.exception = debug_event.u.ExceptionRecord.ExceptionRecord.ExceptionCode
                self.exception_address = debug_event.u.ExceptionRecord.ExceptionRecord.ExceptionAddress
