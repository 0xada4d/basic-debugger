...
# Listen for created files in a directory, if they are .vbs, .ps1, .bat
# inject code into them before they run
...
for path in dirs_to_monitor:
    monitor_thread = threading.Thread(start_monitor, (path,))
